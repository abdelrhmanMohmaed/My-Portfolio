...
const createEducation = async () => {
    await axios.post('/api/store/educations', form.value)
        .then(response => {
            getEducation();
            closeModel();
            toast.fire({
...
const UpdateModal = async () => {
    await axios.post('/api/update/educations/' + form.value.id, form.value)
        .then(() => {
            getEducation();
            closeModel();
            toast.fire({
...
const deleteModal = (educationId) => {
    Swal.fire({
        ...
        if (result.value) {
            axios.get('/api/delete/educations/' + educationId.id).then(() => {
                Swal.fire(
                    'Delete',
            ...
            <section class="educations section" id="educations">
                ...
                <div class="modal main__modal" :class="{ show: showModal }">
                    <div class="modal__content">
                        ...
                        <form @submit.prevent="editMode ? UpdateModal() : createEducation()">
                            <div>
                                <p>Institution</p>
